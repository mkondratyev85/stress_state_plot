...
class Plane:
    ...
    def return_angle_between(self, other):
        ...
        if abs(other.dir - self.dir) == 180 and (other.dip == -1 * self.dip):
            return 180
        angle = self.cos1 * other.cos1 + self.cos2 * other.cos2 + self.cos3 * other.cos3
    ...
    def get_perpendicular_between(self, other):
        ...
        result.define_by_normal_cos(
            (self.cos2 * other.cos3 - self.cos3 * other.cos2) / sin_,
